...
var author$project$Msgs$ReceivedProducts = function (a) {
	return {$: 'ReceivedProducts', a: a};
};
...
var author$project$Models$Product = F3(
	function (name, category, price) {
		return {category: category, name: name, price: price};
	});
var author$project$Models$Accessories = {$: 'Accessories'};
var author$project$Models$Bottoms = {$: 'Bottoms'};
var author$project$Models$Other = {$: 'Other'};
var author$project$Models$Outerwear = {$: 'Outerwear'};
var author$project$Models$Suits = {$: 'Suits'};
var author$project$Models$Tops = {$: 'Tops'};
var elm$core$String$toLower = _String_toLower;
var author$project$Utils$categoryFromString = function (s) {
	var _n0 = elm$core$String$toLower(s);
	switch (_n0) {
		case 'bottoms':
			return author$project$Models$Bottoms;
		case 'tops':
			return author$project$Models$Tops;
		case 'outerwear':
			return author$project$Models$Outerwear;
		case 'suits':
			return author$project$Models$Suits;
		case 'accessories':
			return author$project$Models$Accessories;
		default:
			return author$project$Models$Other;
	}
};
...
var author$project$Utils$productDecoder = A3(
	...
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'category',
		A2(elm$json$Json$Decode$map, author$project$Utils$categoryFromString, elm$json$Json$Decode$string),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'name',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Models$Product))));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Utils$productsDecoder = A2(
	elm$json$Json$Decode$field,
	'products',
	elm$json$Json$Decode$list(author$project$Utils$productDecoder));
...
var author$project$Commands$fetchProducts = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Msgs$ReceivedProducts, author$project$Utils$productsDecoder),
		url: 'http://localhost:9000/products'
	});
var author$project$Models$Home = {$: 'Home'};
var author$project$Models$initialModel = {category: author$project$Models$Bottoms, email: '', loggedIn: false, page: author$project$Models$Home, products: _List_Nil, roster: _List_Nil};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Models$initialModel, author$project$Commands$fetchProducts);
};
...
var author$project$Home$introText = 'Welcome to PantsDuel - the most exciting way to learn about Bonobos product assortment and sales metrics!';
...
var lattyware$elm_fontawesome$FontAwesome$Icon$viewMasked = F4(
	function (attrs, transforms, outer, inner) {
		var _n0 = function () {
			if (outer.$ === 'Just') {
				var mask = outer.a;
				return _Utils_Tuple2(mask.width, mask.height);
			} else {
				return _Utils_Tuple2(inner.width, inner.height);
			}
		}();
		var width = _n0.a;
		var height = _n0.b;
		var classes = 'svg-inline--fa fa-' + (inner.name + (' fa-w-' + elm$core$String$fromInt(
			elm$core$Basics$ceiling((width / height) * 16))));
		var svgTransform = A2(
			elm$core$Maybe$map,
			A2(lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$transformForSvg, width, inner.width),
			...
			if (outer.$ === 'Just') {
				...
				return A3(
					...
					A2(
						...
						A3(lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$transformForSvg, width, inner.width, lattyware$elm_fontawesome$FontAwesome$Transforms$Internal$meaninglessTransform),
						svgTransform),
					mask,
					inner);
			} else {
...
var lattyware$elm_fontawesome$FontAwesome$Solid$chevronRight = A5(lattyware$elm_fontawesome$FontAwesome$Icon$Icon, 'fas', 'chevron-right', 320, 512, 'M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z');
...
var author$project$Home$panel = function (p) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(p.onClick),
				A2(elm$html$Html$Attributes$style, 'line-height', '75px'),
				A2(elm$html$Html$Attributes$style, 'border-top', '1px solid grey')
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								lattyware$elm_fontawesome$FontAwesome$Solid$chevronRight)
							]))
					]))
			]));
};
var author$project$Home$Panel = F2(
	function (onClick, text) {
		return {onClick: onClick, text: text};
	});
var author$project$Models$Roster = {$: 'Roster'};
var author$project$Msgs$NoOp = {$: 'NoOp'};
var author$project$Msgs$View = function (a) {
	return {$: 'View', a: a};
};
var author$project$Home$panels = _List_fromArray(
	[
		A2(
		author$project$Home$Panel,
		author$project$Msgs$View(author$project$Models$Roster),
		'Build Your Daily Roster'),
		A2(
		author$project$Home$Panel,
		author$project$Msgs$View(author$project$Models$Roster),
		'View / Submit Your Daily Roster'),
		A2(author$project$Home$Panel, author$project$Msgs$NoOp, 'View Yesterday\'s Results'),
		A2(author$project$Home$Panel, author$project$Msgs$NoOp, 'Leaderboard')
	]);
...
var author$project$Home$view = A2(
	...
	A2(
		...
		A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text(author$project$Home$introText)
				])),
		A2(elm$core$List$map, author$project$Home$panel, author$project$Home$panels)));
var author$project$Msgs$Login = {$: 'Login'};
var author$project$Msgs$UpdateEmail = function (a) {
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Msgs$UpdateEmail),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(author$project$Msgs$Login),
...
var author$project$Models$categories = _List_fromArray(
	[author$project$Models$Bottoms, author$project$Models$Tops, author$project$Models$Outerwear, author$project$Models$Suits, author$project$Models$Accessories]);
var author$project$Msgs$SubmitRoster = {$: 'SubmitRoster'};
var author$project$Msgs$SelectCategory = function (a) {
...
var author$project$Msgs$selectCategory = A2(elm$core$Basics$composeL, author$project$Msgs$SelectCategory, author$project$Utils$categoryFromString);
var author$project$Msgs$RemoveProduct = function (a) {
	return {$: 'RemoveProduct', a: a};
};
var author$project$Msgs$SelectProduct = function (a) {
	return {$: 'SelectProduct', a: a};
};
var author$project$Utils$budgetLeft = A2(
	elm$core$List$foldr,
	F2(
		function (p, left) {
			return left - p.price;
	...
	5000);
var author$project$Utils$categoryImage = function (category) {
	switch (category.$) {
		case 'Bottoms':
			return 'https://png.pngtree.com/svg/20170804/7007aea49e.svg';
		case 'Tops':
			return 'https://png.pngtree.com/svg/20160621/db3c3c4d9c.svg';
		case 'Outerwear':
			return 'https://png.pngtree.com/svg/20160606/2597271a8b.svg';
		case 'Suits':
			return 'https://png.pngtree.com/svg/20170509/703d28498b.svg';
		case 'Accessories':
			return 'https://png.pngtree.com/svg/20170905/00d644ac9c.svg';
		default:
			return 'https://png.pngtree.com/svg/20161213/a3817a439c.svg';
	}
};
...
var author$project$Utils$currency = A2(
...
var lattyware$elm_fontawesome$FontAwesome$Solid$checkCircle = A5(lattyware$elm_fontawesome$FontAwesome$Icon$Icon, 'fas', 'check-circle', 512, 512, 'M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z');
var lattyware$elm_fontawesome$FontAwesome$Solid$plusCircle = A5(lattyware$elm_fontawesome$FontAwesome$Icon$Icon, 'fas', 'plus-circle', 512, 512, 'M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm144 276c0 6.6-5.4 12-12 12h-92v92c0 6.6-5.4 12-12 12h-56c-6.6 0-12-5.4-12-12v-92h-92c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h92v-92c0-6.6 5.4-12 12-12h56c6.6 0 12 5.4 12 12v92h92c6.6 0 12 5.4 12 12v56z');
...
var author$project$ProductList$productRow = F2(
	function (roster, product) {
		var selected = A2(elm$core$List$member, product, roster);
		var selectable = _Utils_cmp(
			author$project$Utils$budgetLeft(roster),
			product.price) > -1;
		var action = selected ? author$project$Msgs$RemoveProduct : (selectable ? author$project$Msgs$SelectProduct : elm$core$Basics$always(author$project$Msgs$NoOp));
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											author$project$Utils$categoryImage(product.category)),
							...
							rundis$elm_bootstrap$Bootstrap$Grid$col,
							_List_fromArray(
								[rundis$elm_bootstrap$Bootstrap$Grid$Col$middleXs, rundis$elm_bootstrap$Bootstrap$Grid$Col$xs6]),
							_List_fromArray(
								[
									A2(
									elm$html$Html$div,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text(
													author$project$Utils$currency(product.price))
												]))
										]))
								])),
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											lattyware$elm_fontawesome$FontAwesome$Solid$checkCircle) : A2(
											lattyware$elm_fontawesome$FontAwesome$Icon$viewStyled,
											_List_fromArray(
												[
													lattyware$elm_fontawesome$FontAwesome$Attributes$fa2x,
...
var author$project$ProductList$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
			elm$core$List$map,
			author$project$ProductList$productRow(model.roster),
			A2(
				elm$core$List$filter,
				function (p) {
					return _Utils_eq(p.category, model.category);
				},
				model.products)));
};
var author$project$Roster$header = function (budget) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$row,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$Msgs$View(author$project$Models$Home))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Budget Left: ' + budget)
							]))
					]))
			]));
};
...
var author$project$Roster$selectOption = function (v) {
	return A2(
...
var author$project$Utils$categoryDisplay = function (category) {
	switch (category.$) {
		case 'Bottoms':
			return 'Bottoms';
		case 'Tops':
...
var author$project$Roster$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Roster$header(
				author$project$Utils$currency(
					author$project$Utils$budgetLeft(model.roster))),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Roster spots filled: ' + elm$core$String$fromInt(
							elm$core$List$length(model.roster)))
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(author$project$Msgs$SubmitRoster),
										A2(elm$html$Html$Attributes$style, 'width', '100%'),
						...
						_List_fromArray(
							[
								elm$html$Html$text('Submit Roster')
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onInput(author$project$Msgs$selectCategory),
								A2(elm$html$Html$Attributes$style, 'width', '100%')
							]))
					]),
				A2(
					elm$core$List$map,
					A2(elm$core$Basics$composeL, author$project$Roster$selectOption, author$project$Utils$categoryDisplay),
					author$project$Models$categories)),
				author$project$ProductList$view(model)
			]));
};
var author$project$Main$contents = function (model) {
	if (!model.loggedIn) {
		return author$project$Login$view;
	} else {
		var _n0 = model.page;
		if (_n0.$ === 'Home') {
			return author$project$Home$view;
		} else {
			return author$project$Roster$view(model);
		}
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('https://s3-us-west-1.amazonaws.com/static-friendbuy-com/widget/bonobos/landing/img/logo.png'),
								A2(elm$html$Html$Attributes$style, 'width', '80%'),
								A2(elm$html$Html$Attributes$style, 'margin', '25px 0')
							]),
						_List_Nil)
					])),
...
var author$project$Commands$submitRoster = function (roster) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SelectProduct':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							roster: A2(elm$core$List$cons, product, model.roster)
						}),
					elm$core$Platform$Cmd$none);
			case 'RemoveProduct':
				var product = msg.a;
			...
			case 'SubmitRoster':
				return _Utils_Tuple2(
					model,
					author$project$Commands$submitRoster(model.roster));
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		}
	});
